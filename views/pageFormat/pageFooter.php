...
?>
		...
		<footer id="footer" role="contentinfo">
			<div class="container tadl-footer-shell">
				<div class="tadl-footer-inner">
					<div>
						<a class="tadl-footer-logo" href="https://www.tadl.org" target="_blank" rel="noopener">
							<img src="<?= $this->request->getThemeUrlPath(); ?>/assets/pawtucket/graphics/logo.svg" alt="Traverse Area District Library">
						</a>
						<p>Traverse Area District Library connects people, resources, and local stories across the Grand Traverse region.</p>
						<p>Collections and archival materials in this site are presented through TADL's digital collections platform.</p>
					</div>
					<div>
