...
<?php
		...
		print "<br/>".caNavLink($this->request, "<span class='glyphicon glyphicon-th-large' aria-hidden='true'></span> "._t("View Gallery"), "btn btn-primary tadl-gallery-cta", "", "Gallery", $this->getVar("set_id"));
?>
	</div><!-- end col -->
